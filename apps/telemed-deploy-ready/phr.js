(async () => {
  ...
  app.innerHTML = `
    ...
    <section class="card"><div class="hd">Patologias</div><div class="bd">${list(p.patologias)||"Nenhuma patologia registrada"}</div></section>
    <section class="card"><div class="hd">Medicações</div><div class="bd">${list(p.medicacoes)||"Nenhuma medicação em uso"}</div></section>
