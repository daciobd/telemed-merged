// index.js - servidor principal do TeleMed / Medical Desk
...
app.use(
  cors({
    origin: [
      // TODO: adicione aqui o novo domínio do Render quando criar o serviço
      // 'https://telemed-unified.onrender.com',
...
// Outras rotas de API (consultas, pacientes, etc.)
setupAPIRoutes(app);
...
// ============================================
// REACT DASHBOARD (rota principal) - SPA
// ============================================
