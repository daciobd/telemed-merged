...
function App() {
  ...
  const [calculadoraSelecionada, setCalculadoraSelecionada] =
    useState<any>(null);
  ...
  const protocolosFiltrados = useMemo(() => {
    if (
      ...
      !Array.isArray(protocolosClinicosCompletos)
    ) {
      return [];
    }
  ...
  const categorias = useMemo(() => {
    ...
    return [
      "todas",
      ...Array.from(
        new Set(protocolosClinicosCompletos.map((p) => p.categoria)),
      ),
    ];
  }, []);
  ...
  return (
    <Router>
      <Route path="/meet" component={MeetRoom} />

      <Route path="/dr/:customUrl" component={DoctorPublicPage} />
      <Route
        path="/doctor/virtual-office-setup"
        component={VirtualOfficeSetupPage}
      />
...
function MedicalDeskApp({
  ...
  return (
    ...
    >
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div>
                ...
                <p
                  className={`text-sm ${darkMode ? "text-gray-300" : "text-teal-100"}`}
                >
      ...
      {/* Navigation */}
      <nav
        className={`${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border-b sticky top-0 z-10 shadow-sm`}
      >
                ...
                {[
                  {
                    ...
                    value: stats?.protocolosAtivos || 12,
                    icon: FileText,
                    color: "teal",
                    trend: "+12%",
                  },
                  ...
                  return (
                    ...
                    >
                      ...
                      <p
                        className={`text-3xl font-bold ${darkMode ? "text-white" : "text-gray-900"} mt-1`}
                      >
                        {stat.value}
                      </p>
                    </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label
                      className={`block text-sm font-medium ${darkMode ? "text-gray-300" : "text-gray-700"} mb-3`}
                    >
                      Sintomas Relatados
                    </label>
              ...
              <AnimatePresence>
                {result && !loading && (
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      <div
                        className={`${darkMode ? "bg-gray-800" : "bg-white"} rounded-lg p-4`}
                      >
                        <p
                      ...
                      <div>
                        <h4
                          className={`text-lg font-bold ${darkMode ? "text-white" : "text-gray-900"} mb-3 flex items-center space-x-2`}
                        >
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-semibold ${
                          protocolo.categoria === "Cardiologia"
                            ? "bg-red-100 text-red-800"
                            : protocolo.categoria === "Pneumologia"
                              ? "bg-blue-100 text-blue-800"
                              : protocolo.categoria === "Neurologia"
                                ? "bg-purple-100 text-purple-800"
                                : protocolo.categoria === "Trauma"
                                  ? "bg-orange-100 text-orange-800"
                                  : "bg-green-100 text-green-800"
                        }`}
                      >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          <AlertTriangle
                            className={`w-6 h-6 text-${alert.color}-600`}
                          />
                          <h3
                            className={`text-lg font-bold ${darkMode ? "text-white" : "text-gray-900"}`}
                          >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    ...
                    >
                      ...
                      <p
                        className={`text-2xl font-bold text-${trend.color}-600`}
                      >
                        {trend.current}%
                      </p>
                      <p
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p
                  className={`${darkMode ? "text-gray-400" : "text-gray-600"}`}
                >
                  Ferramentas essenciais para cálculos clínicos rápidos e
                  precisos
                </p>
              </div>
            </div>
