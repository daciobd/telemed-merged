...
-   **Documentação**:
    ...
    -   `apps/telemed-deploy-ready/public/pitchdeck.html`: **[NOVO]** Pitch Deck Interativo para Investidores - apresentação one-pager em HTML único com hero section, problema/solução, produto (3 modelos BidConnect), mercado/tração (TAM, GMV, NPS 70+), modelo de negócio com unit economics (R$19.10 margem/consulta, CAC R$45, payback 1.7 meses), comparativo competitivo, roadmap (M0-M12), time/governança e CTAs (demo BidConnect, baixar PDF via print(), contato investidores). Design moderno com gradientes azul/roxo, seções navegáveis por âncoras e responsividade mobile. **Link no menu dropdown** da landing page para acesso direto.
