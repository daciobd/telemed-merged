...
-   **Botão MedicalDesk Atualizado**: **[NOVO - V2.0]** Botão "🔍 Buscar Protocolo" na página /consulta/ implementa busca interativa de protocolos clínicos via API (https://medical-desk-advanced.onrender.com/api/protocols/). Interface com prompt de busca por condição (hipertensão, diabetes, IAM, asma, pneumonia), loading visual, modal de resultados com seções estruturadas (Descrição, Diagnóstico com critérios/exames, Tratamento com lifestyle/medicações, Acompanhamento com frequência/monitoramento), e tratamento de erros elegante. Substitui o botão antigo que tentava abrir /medical-desk-advanced/index.html (404).
