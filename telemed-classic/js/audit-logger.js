...
class AuditLogger {
   ...
   */
  getLogServerUrl() {
    // Usar endpoint customizado se definido
    if (window.AUDIT_LOG_ENDPOINT) {
      return window.AUDIT_LOG_ENDPOINT;
    }
    ...
    // Desenvolvimento: localhost/replit - usar endpoint local
    if (window.location.hostname === 'localhost' || window.location.hostname.includes('replit')) {
      return '/api/logs'; // Endpoint local agora disponível
    }
